...
// Cierre del popup de CTF Informacion del modelo

function showDownloadModal(modalId) {
    if (popupOpen) return;
    ...
    const modalDownload = new bootstrap.Modal(document.getElementById(modalId));
    modalDownload.show();

    document.getElementById(modalId).addEventListener('hidden.bs.modal', closeAllPopups);
}
...
function showUploadModal(modalId) {
    ...
    const modalUpload = new bootstrap.Modal(document.getElementById(modalId));
    modalUpload.show();
...
function showInfoModal(modalId) {
    ...
    const modalInfo = new bootstrap.Modal(document.getElementById(modalId));
    modalInfo.show();
...
document.querySelectorAll('.btnDownload').forEach(button => {
    button.addEventListener('click', function () {
        showDownloadModal('modalDownload2'); // Cambia esto por el ID del modal adecuado
    });
});

document.querySelectorAll('.btnUpload').forEach(button => {
    button.addEventListener('click', function () {
        showUploadModal('modalUpload2'); // Cambia esto por el ID del modal adecuado
    });
});

document.querySelectorAll('.btnInfo').forEach(button => {
    button.addEventListener('click', function () {
        showInfoModal('modalInfo2'); // Cambia esto por el ID del modal adecuado
    });
});
